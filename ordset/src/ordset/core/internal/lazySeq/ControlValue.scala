    ...
    object LazyValue {
      ...
      final case class Unbounded[E, D <: Domain[E], V](
        ...
        override def takeAboveBound(bound: Bound[E]): LazyValue[E, D, V] =
          domainOps.interval.aboveBound(bound.provideLower) match {
            //                  domain
            //        [------------------------]
            //               [///////////////////////////
            //             bound
        ...
        override def takeBelowBound(bound: Bound[E]): LazyValue[E, D, V] =
          domainOps.interval.belowBound(bound.provideUpper) match {
            //                  domain
            //        [------------------------]
            // ////////////////////////)
            //                       bound
      ...
      final case class Bounded[E, D <: Domain[E], V](
        ...
        override def takeAboveBound(bound: Bound[E]): LazyValue[E, D, V] = {
          val requestedInterval = domainOps.interval.aboveBound(bound.provideLower)
          val newInterval = domainOps.intervalOps.cross(requestedInterval, bounds)
          newInterval match {
            //                  bounds
            //        [------------------------]
            //               [///////////////////////////
        ...
        override def takeBelowBound(bound: Bound[E]): LazyValue[E, D, V] = {
          val requestedInterval = domainOps.interval.belowBound(bound.provideUpper)
          val newInterval = domainOps.intervalOps.cross(requestedInterval, bounds)
          newInterval match {
            //                  bounds
            //        [------------------------]
