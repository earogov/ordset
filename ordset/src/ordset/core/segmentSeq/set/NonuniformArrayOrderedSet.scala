...
import ordset.core.segmentSeq.{AbstractArraySegmentSeq, IndexedSegmentSeq, Segment, SegmentSeqException}
import ordset.core.segmentSeq.AbstractIndexedSegmentSeq.{IndexedSegment, IndexedSegmentBase}
