...
//    makeSegment(zippedSeq.getSegment(bound).truncation(bound))
//
...
//      val newZsegment = Stable.assert(newZippedSeq.getSegment(ztruncation.bound))
...
//            newZsegment = newZippedSeq.getSegment(bound)
//          }
//        }
...
//        else newZippedSeq.getSegment(ztruncation.bound)     // search segment in new sequence
//
