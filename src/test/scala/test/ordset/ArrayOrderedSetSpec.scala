...
class ArrayOrderedSetSpec extends AnyFunSpec
  ...
  describe("Array based ordered set as a segment sequence") {
    ...
    it should behave like segmentsSupportMovePrevAndNext("empty set",
      emptyCase.get.firstSegment,
      (false forAll x) :: Nil
    )

    it should behave like segmentsSupportMovePrevAndNext("universal set",
      universalCase.get.firstSegment,
      (true forAll x) :: Nil
    )

    it should behave like segmentsSupportMovePrevAndNext("single bounded set",
    ...
    it should behave like segmentsSupportMovePrevAndNext("multi bounded set",
    ...
    it should behave like segmentsSupportMovePrevAndNext("set with degenerate interval",
    ...
    it should behave like segmentsSupportMoveToBound("empty set",
      emptyCase.get.firstSegment,
      ( 10`)`, false forAll x) ::
      ( 15`[`, false forAll x) ::
      (-10`)`, false forAll x) ::
    ...
    it should behave like segmentsSupportMoveToBound("universal set",
      universalCase.get.firstSegment,
      ( 10`)`, true forAll x) ::
      ( 15`[`, true forAll x) ::
      (-10`)`, true forAll x) ::
    ...
    it should behave like segmentsSupportMoveToBound("single bounded set",
      singleBoundedCase.get.firstSegment,
      ( 10`)`, false forAll x >  0) ::
      ( 15`[`, false forAll x >  0) ::
      (-10`)`, true  forAll x <= 0) ::
    ...
    it should behave like segmentsSupportMoveToBound("multi bounded set",
      multiBoundedCase.get.firstSegment,
    ...
    it should behave like segmentsSupportMoveToBound("set with degenerate interval",
      degenerateCase.get.firstSegment,
    ...
    it should behave like segmentsSupportMoveToFirstAndLast("empty set",
      emptyCase.get,
      false forAll x,
      false forAll x
    )

    it should behave like segmentsSupportMoveToFirstAndLast("universal set",
      universalCase.get,
      true forAll x,
      true forAll x
    )

    it should behave like segmentsSupportMoveToFirstAndLast("single bounded set",
      singleBoundedCase.get,
      true forAll x <=  0,
      false forAll x > 0
    )

    it should behave like segmentsSupportMoveToFirstAndLast("multi bounded set",
      multiBoundedCase.get,
      false forAll x <  0,
      true forAll x >= 40
    )

    it should behave like segmentsSupportMoveToFirstAndLast("set with degenerate interval",
      degenerateCase.get,
      false forAll x <  0,
      false forAll x >= 30
    )
