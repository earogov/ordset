...
//
//abstract class AbstractZippedSegmentSeqTmp[E, W] extends SegmentSeq[E, W] { seq =>
//
//  val valueEq: Eq[W]
//
...
//
//  @tailrec
//  protected final def mergeNext(current: SegmentWithPrev with SegmentWithNext): SegmentWithPrev with SegmentWithNext = {
...
//      case _ => current
//    }
//    // We'v found the bound where operator changes its value => return current segment.
//    else current
//  }
//
//  @tailrec
